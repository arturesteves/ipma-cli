    ...
    execute_command() {
        get_locations_ids(this.args).then(function (locations_ids) {
            if (this.args["forecast"]) {
                ...
                make_request(locations_ids, forecast_day);
            }
                ...
                make_request(request.forecast_location_several_days, util.filter_data_multiple_days, locations_ids, {forecast: this.default.forecast});
            }
