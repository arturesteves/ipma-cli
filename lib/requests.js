...
const log = new Log();
const base_api_url="https://api.ipma.pt/open-data/forecast/meteorology/cities/daily";
...
function forecast_locations_single_day(forecast_day) {
    let url = `${base_api_url}/hp-daily-forecast-day${forecast_day}.json`;
    let options ={...config, uri: url};
    return send_request(options);
}
